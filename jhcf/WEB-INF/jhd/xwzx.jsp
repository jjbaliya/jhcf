...
<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav">
						...
						<li><a
							href="${pageContext.request.contextPath }/GoodsInfo_FindAll.action">公益义卖</a>
						</li>
						<li><a
	...
	<div class="container">
		<s:iterator var="news_mtbd" value="listNews">
			<div class="row">
				<div class="col-md-2"></div>
				<div class="col-md-6">
					<ul class="list-group">
						<a
							href="${pageContext.request.contextPath }/newsAction!defaultNews.go?news.id=${news_mtbd.id}">
							<li class="list-group-item"><c:set var="hxyxwzx"
									value="${news_mtbd.title}"></c:set> <c:out
									value="${fn:substring(hxyxwzx,0,50)}"></c:out>
				</div>
				<div class="col-md-2">
					<fmt:parseDate value="${news_mtbd.date}" var="yearMonth"
						pattern="yyyy-MM-dd" />
					<span style="float:right;"><fmt:formatDate
							value="${yearMonth}" pattern="yyyy-MM-dd" /></span>
			...
			<div class="col-md-8">
				<div class="text-center">
					<div class="pagination">
						...
						<s:else>
							<li><a
								href="${pageContext.request.contextPath }/newsAction!getNewsByGroupname_all.go?currentPage=${currentPage-1}&&groupname=${xwzx.groupname}">&lt;&lt;</a></li>
							<li><a
								href="${pageContext.request.contextPath }/newsAction!getNewsByGroupname_all.go?currentPage=${currentPage-1}&&groupname=${xwzx.groupname}">${currentPage-1}</a></li>
						</s:else>

						<li class="active"><a
							href="${pageContext.request.contextPath }/newsAction!getNewsByGroupname_all.go?currentPage=${sumPage}&&groupname=${xwzx.groupname}">${currentPage}</a>
						</li>
