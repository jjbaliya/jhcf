...
<body>
	<form action="tree_update.action" name="myForm" method="post"
		enctype="multipart/form-data">
		<s:iterator var="list" value="tree">
		<table width="100%" border="0" align="center" cellpadding="0"
			cellspacing="1" bgcolor="d5d4d4">
			<input type="hidden" name="tree.id" value="${list.id }"/>
			<tr>
				<td height="22" colspan="4" background="images/bg.gif"
					bgcolor="#FFFFFF" class="STYLE3"><div align="center">修改成长树页面</div></td>
			</tr>
			<tr>
				<td colspan="4" bgcolor="#FFFFFF" class="STYLE1"><table
						...
						<tr>
							...
							<td height="35" colspan="1" class="STYLE1" style="width: 626px; "><div align="left">
									<input type="text" name="tree.realName" value="${list.realName}"
						...
						<tr>
							...
							<td height="35" colspan="1" class="STYLE1"><div align="left">
									<input class="Wdate" name="tree.birth" type="text" value="${list.birth}"
						...
						<tr>
							...
							<td height="35" colspan="1" class="STYLE1"><div align="left">
									<input type="text" name="tree.ethnic" value="${list.ethnic}"
										style="width: 164px; height:17px; font-size:16px; border:solid 1px #ccc; " />
								</div></td>
						</tr>
						<tr>
							...
							<td height="35" colspan="1" class="STYLE1"><div align="left">
									<input class="Wdate" name="tree.rescueTime" type="text" value="${list.rescueTime}"
										onClick="WdatePicker()"> <font color=red>&lt;-
										点我弹出日期</font>
								</div></td>
						</tr>
						...
						<tr>
							...
							<td height="35" colspan="1" class="STYLE1"><div align="left">
									<textarea name="tree.content"
										style=" width:600px; height:200px;"> ${ list.content}</textarea>
