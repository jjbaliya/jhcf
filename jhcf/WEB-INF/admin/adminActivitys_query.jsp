       ...
       <table>
          ...
          <s:set var="cc" value="%{#allactivitys.cont}"></s:set>
           <s:set var="gg" value="%{#allactivitys.title}"></s:set>
		          ...
		          <img src="images/edt.gif" width="16" height="16" />编辑</a>&nbsp; &nbsp;<a class="STYLE4" onClick="{if(confirm('此操作将删除当前记录!删除后将不能恢复,您确定执行的操作吗?')){return true;}return false;}" href="${pageContext.request.contextPath }/activitysAction!deleteActivitys.go?activitys.id=${allactivitys.id}">
		          <img src="images/del.gif" width="16" height="16" />删除</a></td>
