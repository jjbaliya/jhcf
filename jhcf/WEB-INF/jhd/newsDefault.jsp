...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				<h1 align="center">${defaule_news.title}</h1>
				<h3 align="center">来源：${defaule_news.source }</h3>
				<fmt:parseDate value="${defaule_news.date}" var="yearMonth" pattern="yyyy-MM-dd" /> 
				
				<h3 align="center">发布时间:<fmt:formatDate value="${yearMonth}" pattern="yyyy-MM-dd" /></h3>
