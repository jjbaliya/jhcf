    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
      <% String path = request.getContextPath(); %>
        ...
        <body>
          ...
          <table class="table">
            <tr>
              <td width="12%" height="22" bgcolor="#FFFFFF">
                <div align="center">
                  <span class="STYLE1">
                    <b>序号</b>
                  </span>
            ...
            <s:iterator id="ae" value="#request.activityEnrolls">
              <tr>
                ...
                <td height="20" bgcolor="#FFFFFF">
                  <div align="center">
                    <span class="STYLE1">${ae.name}</span>
                  </div>
                </td>
                <td height="20" bgcolor="#FFFFFF">
                  <div align="center">
                    <span class="STYLE1">${ae.gender}</span>
                  </div>
                </td>
                <td height="20" bgcolor="#FFFFFF">
                  <div align="center">
                ...
                <td height="20" bgcolor="#FFFFFF">
                  <div align="center">
                    <span class="STYLE1">${ae.role}</span>
                  </div>
                </td>
                <td height="20" bgcolor="#FFFFFF">
                  <div align="center">
                    <span class="STYLE1">${ae.carriage}</span>
                  </div>
                </td>
                <td height="20" bgcolor="#FFFFFF">
                  <div align="center">
            ...
            <tr>
              <td colspan="2"> 合计报名人数为:
                <span class="STYLE1">${count}</span>
              </td>
              <td colspan="2">通过人数:
                <span class="STYLE1">${countsuccess}</span>
              </td>
              <td colspan="2">请假人数:
                <span class="STYLE1">${countabsence}</span>
              </td>
            </tr>
          </table>
