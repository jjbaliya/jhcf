 ...
 <div class="container" >
    ...
    <div class="STYLE9"">
      <td  width="12" align="center">页次:${currentPage}/${sumPage}页&nbsp;每页${pageSize}条信息共${count}条
        ...
        <a class="STYLE9" href="${pageContext.request.contextPath}/announcesAction!getAllAnnounces.go?currentPage=1">首页</a>
		
		<s:if test="currentPage==1">上一页</s:if>
		
		
		<s:else>
		<a class="STYLE9" href="${pageContext.request.contextPath }/announcesAction!getAllAnnounces.go?currentPage=${currentPage-1}">上一页</a>
		</s:else>
		
		<s:if test="currentPage>=sumPage">下一页</s:if>
		
		<s:else>
		<a class="STYLE9" href="${pageContext.request.contextPath }/announcesAction!getAllAnnounces.go?currentPage=${currentPage+1}">下一页</a>
		</s:else>
			
		<a class="STYLE9" href="${pageContext.request.contextPath }/announcesAction!getAllAnnounces.go?currentPage=${sumPage}">尾页</a></td>
    </div>
  </div>
