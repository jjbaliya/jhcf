			...
			<div class="col-md-6">
						...
						<s:iterator var="xwzx" value="listAnnounces">
							<a
								...
								<li class="list-group-item"><c:set var="hxyxwzx"
										value="${xwzx.title }"></c:set> <c:out
										value="${fn:substring(hxyxwzx,0,30)}..."></c:out>
										<fmt:parseDate value="${xwzx.date}" var="yearMonth" pattern="yyyy-MM-dd"/>								
										<span><fmt:formatDate value="${yearMonth}" pattern="yyyy-MM-dd"/></span>
							</li>
							</a>
						</s:iterator>
					</ul>
				...
				<div align="center">
					<div class="pagination">
						...
						<s:else>
							<li><a
								href="${pageContext.request.contextPath }/announcesAction!getAllFrontAnnounces.go?currentPage=${currentPage-1}">&lt;&lt;</a></li>
							<li><a
								href="${pageContext.request.contextPath }/newsAction!getAllFrontAnnounces.go?currentPage=${currentPage-1}">${currentPage-1}</a></li>
						</s:else>

						<li class="active"><a
							href="${pageContext.request.contextPath}/newsAction!getAllFrontAnnounces.go?currentPage=1">${currentPage}</a>
						</li>
						...
						<s:else>
							<li><a
								href="${pageContext.request.contextPath }/newsAction!getAllFrontAnnounces.go?currentPage=${currentPage+1}">${currentPage+1}</a></li>
							<li><a
								href="${pageContext.request.contextPath }/newsAction!getAllAnnounces.go?currentPage=${sumPage}">&gt;&gt;</a></li>
						</s:else>
