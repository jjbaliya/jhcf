	...
	<header class="header-section-fixed">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4">
             <form name="myform"  action="${pageContext.request.contextPath }/adminAction2!getAdminByNameAndPassword.go" method="post">
                ...
                <div class="form-group">
                  <label>验证码:</label>
                  <input type="text" name="checkCode" id="checkCode" maxlength="4" class="form-control" required="required" />
